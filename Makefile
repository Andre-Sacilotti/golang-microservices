...
up-dev:
	...
	docker-compose -f ./BaseA/docker-compose.yml up -d 
	docker-compose -f ./citizen_api/docker-compose.yml up -d 
...
down:
	...
	docker-compose -f ./BaseA/docker-compose.yml down --volumes --remove-orphans 
	docker-compose -f ./citizen_api/docker-compose.yml down --volumes --remove-orphans 
...
update-docs:
	...
	swag  init --dir ./citizen_api/
	mv docs ./citizen_api/docs